...
public class BrandService {
	...
	public ApiResponse addBrandDetails(BrandRequestDTO dto) {
		...
		return saveStatus?
			new ApiResponse(true, "brand details saved successfully")
		:
	...
	public ApiResponse updateBrandDetails(BrandRequestDTO dto) {
		...
		return updateStatus?
				new ApiResponse(true, "brand details updated successfully")
			:
	...
	public ApiResponse deactivateBrand(Long id) {
		...
		return updateStatus?
				new ApiResponse(true, "brand details deleted successfully")
			:
